...
public class Order
{
    ...
    public string GeneratePackingLabel()
    {
        ...
        foreach (Product p in _products) 
        {
            packingLabel += p.GetProductName() + " - " + p.GetProductID() + " -> " + p.GetQuantity() + " pieces \n";
        }
        return packingLabel;
    }
    ...
    public string GenerateTotalCost()
    {
        ...
        foreach (Product p in _products) 
        {
            totalCost += p.GetProductName() + " (" + p.GetProductID() + ") - " + "$" + p.GetPrice() + " x " + p.GetQuantity() + " = " + p.CalculatePrice() + "\n";
        }
